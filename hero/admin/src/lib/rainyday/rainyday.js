...
RainyDay.prototype.prepareMiniatures = function()
{
	...
	var miniContext = this.mini.getContext('2d', { willReadFrequently: true });
...
RainyDay.prototype.prepareGlass = function(opacity)
{
	...
	this.context = this.glass.getContext('2d', { willReadFrequently: true });
...
RainyDay.prototype.rain = function(presets, speed)
{
	if (speed > 0) {
		...
		// Patch Hero (2026-04-25) : on stocke l'intervalId pour pouvoir
		// l'arrêter via stop() lors du cleanup React. Sinon le setInterval
		// continue à tourner après l'unmount du composant.
...
// Patch Hero : stop() pour cleanup React
...
// ESM export added by Hero (2026-04-25)
