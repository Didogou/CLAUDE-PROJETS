...
export function AdviceRowActions({ slug, label }: { slug: string; label: string }) {
  ...
  async function handleConfirmDelete() {
    ...
    setError(null);
    try {
      const res = await fetch(`/api/admin/advice/${slug}`, { method: 'DELETE' });
      if (!res.ok) {
        ...
        message={
          <>
            <p>
              ...
              supprimé définitivement, ainsi que son image.
            </p>
